...
<div class="match-item ${winClass}">
    <p class="match-bot-name bot1 ${blueSurrogateClasses[0]}">${match.blue_names[0]}</p>
    <p class="match-bot-name bot2 ${blueSurrogateClasses[1]}">${match.blue_names[1]}</p>
    <p class="match-bot-name bot3 ${blueSurrogateClasses[2]}">${match.blue_names[2]}</p>
